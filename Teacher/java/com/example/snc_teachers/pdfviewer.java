...
public class pdfviewer extends AppCompatActivity {
    String stu_mail,stu_cno,filename,down_url,msg,phn_no;
    ProgressBar pb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* progressBar = new ProgressDialog(pdfviewer.this);
        ...
        phn_no = stu_cno.trim();
        msg="This message is from S.N. Classes,Fees Payment Successful,Receipt has been mailed to you..If not received please contact Classes Owner";
